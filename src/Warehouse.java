...
//import util.Utils; commented to avoid compilation error

public final class Warehouse {
    // Fruit name to amount of it in warehouse
    private final Map<String, Integer> entry = new HashMap<>(); // orange, banana, etc...
    ...
    /**
     * @param fruitName some fruit name from Utils.FRUITS (mango, orange...)
     */
